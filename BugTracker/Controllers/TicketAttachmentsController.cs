...
namespace BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,TicketTaskId,UserId,Created,FileData,FileName,FileType,Description")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,TicketTaskId,UserId,Created,FileData,FileName,FileType,Description")] TicketAttachment ticketAttachment)
        {
